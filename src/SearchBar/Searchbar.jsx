...
export default function Searchbar({setsearchLogic , GettingSearchInput, inputRef}) {
  ...
  return (
   ...
   { showPopUp && <SpeachRecognization setsearchLogic={setsearchLogic} showPopUp={showPopUp} setshowPopUp={setshowPopUp}    transcript={transcript} listening={listening} resetTranscript={resetTranscript} browserSupportsSpeechRecognition={browserSupportsSpeechRecognition}/>}
